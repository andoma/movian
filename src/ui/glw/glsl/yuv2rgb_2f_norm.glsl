...
uniform mat4      u_colormtx1;
uniform mat4      u_colormtx2;
...
void main()
{
  vec3 rgb1 = vec3(u_colormtx1 * vec4(texture2D(u_t0, f_tex0).r,
				     texture2D(u_t1, f_tex0).r,
				     texture2D(u_t2, f_tex0).r,
				     1));
  
  vec3 rgb2 = vec3(u_colormtx2 * vec4(texture2D(u_t3, f_tex1).r,
