...
{
  const float *src = (const float *)&src_[0];
...
{
  rc->rc_mtx[0]  = (__m128){1, 0, 0, 0};
  rc->rc_mtx[1]  = (__m128){0, 1, 0, 0};
  rc->rc_mtx[2]  = (__m128){0, 0, 1, 0};
  rc->rc_mtx[3]  = (__m128){0, 0, 0, 1};
}
