...
static bool(*f_sp_track_is_starred)(sp_track *track);
static void(*f_sp_track_set_starred)(sp_session *session, const sp_track **tracks, int num_tracks, bool star);
...
#define f_sp_session_init sp_session_init
