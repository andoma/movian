 ...
 */
struct xa_subhdr {
	unsigned char	file_number;		/* Identifies file for block	*/
	unsigned char	channel_number;		/* Playback channel selection	*/
	unsigned char	sub_mode;		/* See bit definitions below	*/
	unsigned char	coding;			/* Coding information		*/
};
