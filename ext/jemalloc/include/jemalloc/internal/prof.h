...
#define	LG_PROF_BT_MAX_DEFAULT		6

#define	LG_PROF_SAMPLE_DEFAULT		10
...
#else
#  define LG_PROF_BT_MAX	6 /* >= LG_PROF_BT_MAX_DEFAULT */
#endif
...
#  define PROF_TCACHE_SET(v)	do {					\
	prof_tdata_tls = (v);						\
	hts_thread_set_specific(prof_tdata_tsd, (void *)(v));		\
} while (0)
#else
#  define PROF_TCACHE_GET()						\
	((prof_tdata_t *)hts_thread_get_specific(prof_tdata_tsd))
#  define PROF_TCACHE_SET(v)	do {					\
	hts_thread_set_specific(prof_tdata_tsd, (void *)(v));		\
} while (0)
#endif
 ...
 */
extern hts_key_t	prof_tdata_tsd;
